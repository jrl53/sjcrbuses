...
app.main = function() {
    ...
    initialize : function() {
        this.myLatlng = new google.maps.LatLng(9.934781, -84.083839);
        this.myOptions = {
          zoom: 13,
    ...
    url:function() {
		...
		//return app.params.urlFusionTable+"?sql=SELECT geometry FROM "+app.params.idFusionTable_JL+" WHERE name STARTS WITH '"+this.name+"'&key="+app.params.keyFusionTable+"&callback=?";
	},
